	...
	<tr>
		<td width="33%" valign="top" style="background-color: #0d1117; font-family: monospace; border-radius: 8px; border: 1px solid #1a1a1a; padding: 15px;">
			...
			<span style="color: #8b949e;">
				Всі посилання активні. З'єднання стабільне<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=800&size=16&pause=500&color=8b949e&width=20&height=4&vCenter=false&lines=_;%20" alt="blinking cursor" style="vertical-align: middle; margin-bottom: 2px;">
			</span> 
		</td>
	</tr>
</table>