<div align="right">
	<samp><a href="README.md" style="text-decoration: none;"><b style="font-size: 13px; color: #c4a052;">EN</b></a>  | <a href="README_GR.md" style="text-decoration: none;"><b style="font-size: 13px; color: #c4a052;">GR</b></a> | <a href="README_RU.md" style="text-decoration: none;"><b style="font-size: 13px; color: #c4a052;">RU</b></a> | <b style="font-size: 14px; color: #ffffff;">UA</b></samp>
</div>
<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="60%" valign="top">
			...
			<h1 style="margin: 0; font-size: 42px;"><samp>Δp.BopoN<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=800&size=36&pause=500&color=ffffff&width=307&height=28&vCenter=true&lines=_;%20" alt="blinking cursor" style="vertical-align: middle; margin-bottom: 2px;"></samp></h1>
			...
			<blockquote style="border-left: 2px solid #30363d; margin: 0; padding-left: 15px; padding-right: 15px;">
				...
				<div align="left" style="margin-top: 5px;">
					<samp style="color: #6e7681; font-size: 12px;">— Я люблю насолоджуватися прекрасним, як Будда: хіба не в цьому сенс життя?</samp>
				</div>
			</blockquote>
		</td>
		<td width="40%" valign="top" align="left">
			...
			<div style="border-left: 1px solid #30363d; padding-left: 20px; margin-top: 10px;">
				...
				<samp style="color: #6e7681; font-size: 12px; letter-spacing: 1px;">[ ІНСТРУМЕНТИ ]</samp><br>
				<div style="margin-top: 5px; line-height: 1.8;">
					...
					<img src="https://img.shields.io/badge/Рушій-Godot-c4a052?style=flat-square&labelColor=000000&logo=godotengine&logoColor=white">
					<img src="https://img.shields.io/badge/Мова-Python-c4a052?style=flat-square&labelColor=000000&logo=python&logoColor=white"><br>
					<img src="https://img.shields.io/badge/Мова-Zig-c4a052?style=flat-square&labelColor=000000&logo=zig&logoColor=white">
				</div>
			</div>
		</td>
	</tr>
	...
	<tr>
		<td width="33%" valign="top" style="background-color: #0d1117; border-radius: 8px; border: 1px solid #1a1a1a; padding: 15px;">
			...
			<ul style="color: #8b949e; font-family: monospace; font-size: 14px; padding-left: 20px; margin: 0; list-style-type: square;">
				<li>Дата-орієнтований дизайн (DOD)</li>
				<li>Entity Component System (ECS)</li>
				<li>Управління пам'яттю (ZIG, C++)</li>
				<li>Архітектура VFS та ОС</li>
			</ul>
		</td>
		<td width="33%" valign="top" style="background-color: #0d1117; border-radius: 8px; border: 1px solid #1a1a1a; padding: 15px;">
			...
			<ul style="color: #8b949e; font-family: monospace; font-size: 14px; padding-left: 20px; margin: 0; list-style-type: square;">
				<li>Архітектура рендеру (Vulkan)</li>
				<li>PBR пайплайн та запікання карт</li>
				<li>Шейдери (GLSL)</li>
				<li>Оптимізація топології мешів</li>
			</ul>
		</td>
		<td width="33%" valign="top" style="background-color: #0d1117; border-radius: 8px; border: 1px solid #1a1a1a; padding: 15px;">
			...
			<ul style="color: #8b949e; font-family: monospace; font-size: 14px; padding-left: 20px; margin: 0; list-style-type: square;">
				...
				<li>Створення інструментів / Автоматизація</li>
				<li>Інтеграція API (REST)</li>
				<li>Середовище Arch Linux</li>
			</ul>
		</td>
	</tr>
</table>
	...
	<tr>
		<td width="33%" valign="top" style="background-color: #0d1117; font-family: monospace; border-radius: 8px; border: 1px solid #1a1a1a; padding: 15px;">
			...
			<span style="color: #8b949e;">
				Всі посилання активні. З'єднання стабільне<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=800&size=16&pause=500&color=8b949e&width=20&height=24&vCenter=true&lines=_;%20" alt="blinking cursor" style="vertical-align: middle; margin-bottom: 2px;">
			</span> 
		</td>
	</tr>
</table>