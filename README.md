...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="60%" valign="top">
			...
			<h1 style="margin: 0; font-size: 42px;"><samp>Δp.BopoN<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=800&size=42&pause=500&color=ffffff&width=307&height=24&vCenter=true&lines=_;%20" alt="blinking cursor" style="vertical-align: middle; margin-bottom: 2px;"></samp></h1>
